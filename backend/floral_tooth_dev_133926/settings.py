"""
Django settings for floral_tooth_dev_133926 project.
...
ROOT_URLCONF = 'floral_tooth_dev_133926.urls'
...
WSGI_APPLICATION = 'floral_tooth_dev_133926.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floral_tooth_dev_133926 API",
    "DESCRIPTION": "API documentation for floral_tooth_dev_133926 App",
    "VERSION": "v1",
}
